...
public class Player : Entity
{
    ...
    public void resetBeforeBattle(){
        ...
        transform.position = new Vector3(-2,-4.119578f,0);
    ...
    void Update(){
        ...
        else if (gameObject.GetComponent<ActionsManager>().movingNextToEnemyToSacrifice){

            if (gameObject.GetComponent<ActionsManager>().side.Equals("left")){
                if (!gameObject.GetComponent<ActionsManager>().canAttack_Melee){
                    ...
                    gameObject.GetComponent<ActionsManager>().stopMovingToEnemyToSacrifice();
                    if (!gameObject.GetComponent<ActionsManager>().movingNextToEnemyToSacrifice){
                        gameObject.GetComponent<ActionsManager>().sacrificeEnemyAttackAnim();
                    }
                }
            }
        else if (gameObject.GetComponent<ActionsManager>().side.Equals("right")){
        ...
        else if (gameObject.GetComponent<ActionsManager>().sacrificialAttack){
            animator.SetBool("Idle",false);
        }

        else if (gameObject.GetComponent<ActionsManager>().sparing){
            animator.SetBool("Idle",false);
        }
