...
public class Enemy : Entity
{
    ...
    public void resetBeforeBattle(){
        ...
        gameObject.transform.position = new Vector3(2,-4.119578f,0);
    ...
    void Update(){
        ...
        else if (gameObject.GetComponent<EnemyActionsManager>().movingNextToEnemyToSacrifice){

            if (gameObject.GetComponent<EnemyActionsManager>().side.Equals("left")){
                if (!gameObject.GetComponent<EnemyActionsManager>().canAttack_Melee){
                    ...
                    gameObject.GetComponent<EnemyActionsManager>().stopMovingToEnemyToSacrifice();
                    if (!gameObject.GetComponent<EnemyActionsManager>().movingNextToEnemyToSacrifice){
                        gameObject.GetComponent<EnemyActionsManager>().sacrificeEnemyAttackAnim();
                    }
                }
            }
            else if (gameObject.GetComponent<EnemyActionsManager>().side.Equals("right")){
        ...
        else if (gameObject.GetComponent<EnemyActionsManager>().sacrificialAttack){
            animator.SetBool("Idle",false);
        }

        else if (gameObject.GetComponent<EnemyActionsManager>().sparing){
            animator.SetBool("Idle",false);
        }
